...
sample_metadata = OrderedDict([
    ('LacZ_1_b1', {
       'condition': 'LacZ OE',
       'roi_path': 'batch1/LacZ_1_Dimm_Bsh_Fs_cp_masks.tif',
       'signal_path': 'batch1/LacZ_1_Dimm_Bsh_Fs.tif',
       'rotation': 115,
    }),
    ('LacZ_2_b1', {
       'condition': 'LacZ OE',
       'roi_path': 'batch1/LacZ_2_Dimm_Bsh_Fs_cp_masks.tif',
       'signal_path': 'batch1/LacZ_2_Dimm_Bsh_Fs.tif',
       'rotation': -95,
    }),
    ('LacZ_3_b1', {
       'condition': 'LacZ OE',
       'roi_path': 'batch1/LacZ_3_Dimm_Bsh_Fs_cp_masks.tif',
       'signal_path': 'batch1/LacZ_3_Dimm_Bsh_Fs.tif',
       'rotation': 80,
    }),
    ('LacZ_4_b1', {
       'condition': 'LacZ OE',
       'roi_path': 'batch1/LacZ_4_Dimm_Bsh_Fs_cp_masks.tif',
       'signal_path': 'batch1/LacZ_4_Dimm_Bsh_Fs.tif',
       'rotation': 80,
    }),
    ('Bi_1_b1', {
        'condition': 'Bi OE',
        'roi_path': 'batch1/Bi_1_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch1/Bi_1_Dimm_Bsh_Fs.tif',
        'rotation': 85,
    }),
    ('Bi_2_b1', {
        'condition': 'Bi OE',
        'roi_path': 'batch1/Bi_2_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch1/Bi_2_Dimm_Bsh_Fs.tif',
        'rotation': -95,
    }),
    ('Bi_3_b1', {
        'condition': 'Bi OE',
        'roi_path': 'batch1/Bi_3_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch1/Bi_3_Dimm_Bsh_Fs.tif',
        'rotation': 75,
    }),
    ('LacZ_1_b2', {
        'condition': 'LacZ OE',
        'roi_path': 'batch2/LacZ_1_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch2/LacZ_1_Dimm_Bsh_Fs.tif',
        'rotation': -95,
    }),
    ('LacZ_2_b2', {
       'condition': 'LacZ OE',
       'roi_path': 'batch2/LacZ_2_Dimm_Bsh_Fs_cp_masks.tif',
       'signal_path': 'batch2/LacZ_2_Dimm_Bsh_Fs.tif',
       'rotation': 85,
    }),
    ('LacZ_3_b2', {
       'condition': 'LacZ OE',
       'roi_path': 'batch2/LacZ_3_Dimm_Bsh_Fs_cp_masks.tif',
       'signal_path': 'batch2/LacZ_3_Dimm_Bsh_Fs.tif',
       'rotation': 75,
    }),
    ('Bi_1_b2', {
        'condition': 'Bi OE',
        'roi_path': 'batch2/Bi_1_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch2/Bi_1_Dimm_Bsh_Fs.tif',
        'rotation': 75,
    }),
    ('Bi_2_b2', {
        'condition': 'Bi OE',
        'roi_path': 'batch2/Bi_2_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch2/Bi_2_Dimm_Bsh_Fs.tif',
        'rotation': 95,
    }),
    ('Bi_3_b2', {
        'condition': 'Bi OE',
        'roi_path': 'batch2/Bi_3_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch2/Bi_3_Dimm_Bsh_Fs.tif',
        'rotation': -75,
    }),
    ('LacZ_2_b3', {
        'condition': 'LacZ OE',
        'roi_path': 'batch3/LacZ_2_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch3/LacZ_2_Dimm_Bsh_Fs.tif',
        'rotation': -90,
    }),
    ('LacZ_3_b3', {
        'condition': 'LacZ OE',
        'roi_path': 'batch3/LacZ_3_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch3/LacZ_3_Dimm_Bsh_Fs.tif',
        'rotation': 80,
    }),
    ('Bi_1_b3', {
        'condition': 'Bi OE',
        'roi_path': 'batch3/Bi_1_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch3/Bi_1_Dimm_Bsh_Fs.tif',
        'rotation': -90,
    }),
    ('Bi_2_b3', {
        'condition': 'Bi OE',
        'roi_path': 'batch3/Bi_2_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch3/Bi_2_Dimm_Bsh_Fs.tif',
        'rotation': -100,
    }),
    ('Bi_3_b3', {
        'condition': 'Bi OE',
        'roi_path': 'batch3/Bi_3_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch3/Bi_3_Dimm_Bsh_Fs.tif',
        'rotation': -80,
    }),
    ('Bi_4_b3', {
        'condition': 'Bi OE',
        'roi_path': 'batch3/Bi_4_Dimm_Bsh_Fs_cp_masks.tif',
        'signal_path': 'batch3/Bi_4_Dimm_Bsh_Fs.tif',
        'rotation': -100,
    })
])
...
for m in sample_metadata:
  ...
  if sample_metadata[m]['condition'] == control_condition:
    with_TE = pcaobj[outdf['int_0'] > threshold, 2]
    if len(with_TE) == 0:
      raise ValueError(
        f"Control sample {m} has no int_0 values above threshold {threshold}"
      )
    with_TE_min = np.percentile(with_TE, 10)
    with_TE_max = np.percentile(with_TE, 90)
    control_depth_ranges.append((
         (with_TE_min - pcaobj[:, 2].min()) / depth_ptp,
         (with_TE_max - pcaobj[:, 2].min()) / depth_ptp
    ))
...
for m, result in sample_results.items():
  ...
  with_TE_min = mean_min * depth_ptp + pcaobj[:, 2].min()
  with_TE_max = mean_max * depth_ptp + pcaobj[:, 2].min()
  depth_to_keep = (pcaobj[:, 2] > with_TE_min) & (pcaobj[:, 2] < with_TE_max)
  ...
  logger.info(
    "Sample %s: output_rows=%d, with_TE__min=%.6f, with_TE__max=%.6f, in_plane_rows=%d",
    m,
    len(outdf),
    with_TE_min,
    with_TE_max,
