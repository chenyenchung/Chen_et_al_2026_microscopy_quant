...
sample_metadata = OrderedDict([
   ('mCherryi_1', {
      ...
      'roi_path': './batch1-20241120/mCherryi_1_cortex_0.24_cp_masks.tif',
      'signal_path': './batch1-20241120/mCherryi_1_cortex_0.24.tif',
      'rotation': -95
   }),
   ('mCherryi_2', {
      'condition': 'mCherry RNAi',
      'roi_path': './batch1-20241120/mCherryi_2_0.21_cp_masks.tif',
      'signal_path': './batch1-20241120/mCherryi_2_0.21.tif',
      'rotation': 180
   }),
   ('mCherryi_3', {
     'condition': 'mCherry RNAi',
     'roi_path': './batch1-20241120/mCherryi_3_0.22_cp_masks.tif',
     'signal_path': './batch1-20241120/mCherryi_3_0.22.tif',
     'rotation': 20
   }),
   ('Ezi_1', {
      'condition': 'E(z) RNAi',
      'roi_path': './batch1-20241120/Ezi_1_cortex_0.20_cp_masks.tif',
      'signal_path': './batch1-20241120/Ezi_1_cortex_0.20.tif',
      'rotation': -70
   }),
   ('Ezi_2', {
      'condition': 'E(z) RNAi',
      'roi_path': './batch1-20241120/Ezi_2_cortex_0.20_cp_masks.tif',
      'signal_path': './batch1-20241120/Ezi_2_cortex_0.20.tif',
      'rotation': 65
   }),
   ('Ezi_3', {
      'condition': 'E(z) RNAi',
      'roi_path': './batch1-20241120/Ezi_3_0.20_cp_masks.tif',
      'signal_path': './batch1-20241120/Ezi_3_0.20.tif',
      'rotation': 90
   }),
])
