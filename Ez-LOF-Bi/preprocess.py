...
sample_metadata = OrderedDict([
    ('mCherryi_1_b2', {
       ...
       'roi_path': 'batch2/mCherryi_1_bi_cp_masks.tif',
       'signal_path': 'batch2/mCherryi_1_bi.tif',
       'rotation': -85,
    }),
    ('mCherryi_2_b2', {
       'condition': 'mCherry RNAi',
       'roi_path': 'batch2/mCherryi_2_bi_cp_masks.tif',
       'signal_path': 'batch2/mCherryi_2_bi.tif',
       'rotation': 60,
    }),
    ('mCherryi_3_b2', {
       'condition': 'mCherry RNAi',
       'roi_path': 'batch2/mCherryi_3_bi_cp_masks.tif',
       'signal_path': 'batch2/mCherryi_3_bi.tif',
       'rotation': 55,
    }),
    ('mCherryi_4_b2', {
         'condition': 'mCherry RNAi',
         'roi_path': 'batch2/mCherryi_4_bi_cp_masks.tif',
         'signal_path': 'batch2/mCherryi_4_bi.tif',
         'rotation': 65,
    }),
    ('Ezi_1_b2', {
       'condition': 'Ezi RNAi',
       'roi_path': 'batch2/Ezi_1_bi_cp_masks.tif',
       'signal_path': 'batch2/Ezi_1_bi.tif',
       'rotation': 100,
    }),
    ('Ezi_2_b2', {
        'condition': 'Ezi RNAi',
        'roi_path': 'batch2/Ezi_2_bi_cp_masks.tif',
        'signal_path': 'batch2/Ezi_2_bi.tif',
        'rotation': 125,
    }),
    ('Ezi_3_b2', {
        'condition': 'Ezi RNAi',
        'roi_path': 'batch2/Ezi_3_bi_cp_masks.tif',
        'signal_path': 'batch2/Ezi_3_bi.tif',
        'rotation': 95,
    }),
    ('Ezi_3_b1', {
        'condition': 'Ezi RNAi',
        'roi_path': 'batch1/Ezi_3_highlaser_bi_cp_masks.tif',
        'signal_path': 'batch1/Ezi_3_highlaser_bi.tif',
        'rotation': -80,
    })
])
