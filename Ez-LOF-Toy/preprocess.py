...
sample_metadata = OrderedDict([
   ('mCherryi_1', {
      ...
      'roi_path': 'batch1/mCherryi_1_0.24_cp_masks.tif',
      'signal_path': 'batch1/mCherryi_1_0.24.tif',
      'rotation': 15
   }),
   ('mCherryi_2', {
      'condition': 'mCherry RNAi',
   ...
   ('mCherryi_3', {
     'condition': 'mCherry RNAi',
     'roi_path': 'batch1/mCherryi_3_0.24_cp_masks.tif',
     'signal_path': 'batch1/mCherryi_3_0.24.tif',
     'rotation': 75
   }),
   ('Ezi_1', {
      'condition': 'E(z) RNAi',
      'roi_path': 'batch1/Ezi_1_0.24_cp_masks.tif',
      'signal_path': 'batch1/Ezi_1_0.24.tif',
      'rotation': -110
   }),
   ('Ezi_2', {
      'condition': 'E(z) RNAi',
      'roi_path': 'batch1/Ezi_2_0.24_cp_masks.tif',
      'signal_path': 'batch1/Ezi_2_0.24.tif',
      'rotation': -190
   }),
   ('Ezi_3', {
      'condition': 'E(z) RNAi',
      'roi_path': 'batch1/Ezi_3_0.24_cp_masks.tif',
      'signal_path': 'batch1/Ezi_3_0.24.tif',
      'rotation': -10
   }),
])
