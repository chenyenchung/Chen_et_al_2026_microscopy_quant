...
sample_metadata = OrderedDict([
  ('mChi_1', {
    'rotation': 70,
    'thres': 2000,
    'roi_path': 'data/mChi_1_Vsx1_0.241_cp_masks.tif',
    'signal_path': 'data/mChi_1_Vsx1_0.241.tif',
    'condition': 'mCherry RNAi'
  }),
  ('mChi_2', {
    'rotation': 95,
    'thres': 2000,
    'roi_path': 'data/mChi_2_Vsx1_0.241_cp_masks.tif',
    'signal_path': 'data/mChi_2_Vsx1_0.241.tif',
    'condition': 'mCherry RNAi'
  }),
  ('mChi_3', {
    'rotation': 80,
    'thres': 2000,
    'roi_path': 'data/mChi_3_Vsx1_0.241_cp_masks.tif',
    'signal_path': 'data/mChi_3_Vsx1_0.241.tif',
    'condition': 'mCherry RNAi'
  }),
  ('Ezi_1', {
    'rotation': -90,
    'thres': 2000,
    'roi_path': 'data/Ezi_1_Vsx1_0.232_cp_masks.tif',
    'signal_path': 'data/Ezi_1_Vsx1_0.232.tif',
    'condition': 'E(z) RNAi'}),
  ('Ezi_2', {
    'rotation': -80,
    'thres': 2000,
    'roi_path': 'data/Ezi_2_Vsx1_0.232_cp_masks.tif',
    'signal_path': 'data/Ezi_2_Vsx1_0.232.tif',
    'condition': 'E(z) RNAi'}),
  ('Ezi_3', {
    'rotation': 100,
    'thres': 2000,
    'roi_path': 'data/Ezi_3_Vsx1_0.232_cp_masks.tif',
    'signal_path': 'data/Ezi_3_Vsx1_0.232.tif',
    'condition': 'E(z) RNAi'}),
  ('Ezi_4', {
    'rotation': -85,
    'thres': 2000,
    'roi_path': 'data/Ezi_4_Vsx1_0.241_cp_masks.tif',
    'signal_path': 'data/Ezi_4_Vsx1_0.241.tif',
    'condition': 'E(z) RNAi'})
])
