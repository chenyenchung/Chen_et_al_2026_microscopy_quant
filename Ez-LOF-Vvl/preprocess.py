...
sample_metadata = OrderedDict([
   ('mCherryi_1_b1', {
      ...
      'roi_path': 'batch1/mCherryi_1_0.21_cp_masks.tif',
      'signal_path': 'batch1/mCherryi_1_0.21.tif',
      'rotation': -80
   }),
   ('mCherryi_2_b1', {
      'condition': 'mCherry RNAi',
      'roi_path': 'batch1/mCherryi_2_0.24_cp_masks.tif',
      'signal_path': 'batch1/mCherryi_2_0.24.tif',
      'rotation': 105
   }),
   ('mCherryi_1_b2', {
      'condition': 'mCherry RNAi',
      'roi_path': 'batch2/mCherryi_1_0.24_cp_masks.tif',
      'signal_path': 'batch2/mCherryi_1_0.24.tif',
      'rotation': -85
   }),
   ('mCherryi_2_b2', {
      'condition': 'mCherry RNAi',
      'roi_path': 'batch2/mCherryi_2_0.24_cp_masks.tif',
      'signal_path': 'batch2/mCherryi_2_0.24.tif',
      'rotation': 70
   }),
   ('Ezi_3_b1', {
      'condition': 'E(z) RNAi',
      'roi_path': 'batch1/Ezi_3_highlaser_0.24_cp_masks.tif',
      'signal_path': 'batch1/Ezi_3_highlaser_0.24.tif',
      'rotation': -65
   }),
   ('Ezi_1_b2', {
      'condition': 'E(z) RNAi',
      'roi_path': 'batch2/Ezi_1_0.24_cp_masks.tif',
      'signal_path': 'batch2/Ezi_1_0.24.tif',
      'rotation': 110
   }),
   ('Ezi_2_b2', {
      'condition': 'E(z) RNAi',
      'roi_path': 'batch2/Ezi_2_0.24_cp_masks.tif',
      'signal_path': 'batch2/Ezi_2_0.24.tif',
      'rotation': 100
   }),
])
