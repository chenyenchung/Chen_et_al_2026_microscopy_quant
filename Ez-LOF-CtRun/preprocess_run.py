...
sample_metadata = OrderedDict([
  ('mChKD_1', {
    'rotation': -100,
    'roi_path': 'data/mChi_1_run_0.241_cp_masks.tif',
    'signal_path': 'data/mChi_1_run_0.241.tif',
    'condition': 'mCherry RNAi'
  }),
  ('mChKD_2', {
    'rotation': 85,
    'roi_path': 'data/mChi_2_run_0.224_cp_masks.tif',
    'signal_path': 'data/mChi_2_run_0.224.tif',
    'condition': 'mCherry RNAi'
  }),
  ('Ezi_1', {
    'rotation': -95,
    'roi_path': 'data/ezi_1_run_0.241_cp_masks.tif',
    'signal_path': 'data/ezi_1_run_0.241.tif',
    'condition': 'E(z) RNAi'
  }),
  ('Ezi_2', {
    'rotation': -110,
    'roi_path': 'data/ezi_2_run_0.224_cp_masks.tif',
    'signal_path': 'data/ezi_2_run_0.224.tif',
    'condition': 'E(z) RNAi'
  })
])
...
for m in sample_metadata:
  ...
  outdf = outdf[outdf['int'] > 20000].reset_index(drop = True)
  ...
  outdf.to_csv(f'result/{m}_run_preprocessed.csv', index=False)